...
<body>
  ...
  <div class="container">
  <a href="http://localhost/Donate_Life/index.php" class="logo"><img src="assets/images/logo.png" height="170" width="200" alt="Logo.png"></a>
  ...
  <section class="section hero" id="home" style="background-image: url('./assets/images/hero-bg.png')" aria-label="hero">
    <div class="container">
      <div class="hero-content">
        ...
        <p class="hero-text">
          Welcome to Donate Life, a dedicated community-driven platform that aims to connect blood donors and recipients seamlessly.
  ...
  <section class="section hero" id="home" style="background-image: url('./assets/images/hero-bg.png')" aria-label="hero">
    <div class="container">
      ...
      <figure class="hero-banner">
        ...
        <p class="hero-text">We are a passionate group of individuals who believe in the power of community and the importance of blood donation.
          Our team consists of healthcare professionals, technology enthusiasts, and compassionate volunteers who are committed to making a difference in the lives of those in need.
          We understand the challenges faced by both donors and recipients, and we are here to provide a solution that simplifies the process and enhances the experience for everyone involved.
          Our platform is designed to be user-friendly and efficient, ensuring that donors can easily register and offer their blood, while recipients can quickly find the help they need.
        <p style="font-size: larger;"></p>
      </figure>
    </div>
  </section>
  ...
  <section class="section hero" id="home" style="background-image: url('./assets/images/hero-bg.png')" aria-label="hero">
    <div class="container">
      <div class="hero-content">
        ...
        <p class="hero-text">
          At Donate Life, we envision a world where blood donation is not just a necessity but a way of life. We aim to create a culture of giving and receiving blood that transcends barriers and unites individuals in the noble cause of saving lives.
          Our platform is designed to empower both donors and recipients, ensuring that no one has to face the challenges of finding compatible blood alone.
          We believe that together, we can make a difference and create a healthier, more compassionate society
        </p>
      </div>
      <figure class="hero-banner">
  ...
  <section class="section hero" id="home" style="background-image: url('./assets/images/hero-bg.png')" aria-label="hero">
    ...
    <div class="row" style="overflow: hidden; padding: 1cm;">
      <!-- First Column -->
      <div class="column">
        <h1 style="color: var(--oxford-blue-1); font-size: var(--fs-1);">Join the Donate LifeCommunity</h1>
        <br>
        <p style="font-size: 17px;">
          We invite you to join our growing community of blood donors and recipients. By becoming a part of Donate Life,
      ...
      <div class="column">
        ...
        <br>
        <p style="font-size: 17px;">
          At Donate Life  , we firmly believe that when individuals come together with a common purpose, remarkable things can happen. With your support and participation,
      ...
      <div class="column">
        ...
        <p style="font-size: 17px;">
          ...
          You can call or message at <a href="tel:++977-9863442248" class="footer-link" style="display: inline; color: #216aca;" onmouseover="this.style.color='#03d9ff'" onmouseout="this.style.color='#216aca'">+977-986442248 to donate fund</a>.
        </p>
      </div>
    </div>
