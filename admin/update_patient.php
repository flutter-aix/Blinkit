...
if ($_SERVER["REQUEST_METHOD"] == 'GET') {
  ...
  $sql = $conn->prepare("SELECT * FROM patient_reg WHERE pid = ?");
...
if ($_SERVER["REQUEST_METHOD"] == 'POST') {
  ...
  $sql = $conn->prepare("UPDATE patient_reg SET full_name = ?, mobile_number = ?, email = ?, gender = ? WHERE pid = ?");
    $sql->bind_param("ssssi", $name, $mobile_number, $email, $gender,$pid);
