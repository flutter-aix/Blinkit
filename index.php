...
.image-animation {
  width: 400px; /* Adjust to the desired width */
  height: auto; /* Maintain aspect ratio */
  transition: transform 0.5s ease-in-out;
  animation: slideInLeft 2s ease-out; /* 2 seconds duration */
  display: block;
  margin: 0 auto;
...
/* Show the image after the animation */
      ...
      <section class="section hero" id="home" style="background-image: url('./assets/images/hero-bg.png')" aria-label="hero">
        <div class="container">
          ...
          <figure class="hero-banner">
            ...
            <img src="./assets/images/doctor_amrit.png" width="587" height="839" class="image-animation" alt="hero banner" id="animatedImage" >
            <!-- <img src="./assets/images/frontimage.gif" width="587" height="839" alt="hero banner" class="w-100"> -->
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $city = $_POST["city"];
        ...
        if($count>0){
            echo "<script>
            Swal.fire({
              title: ' " . $count . " " . $blood_group . " blood group donor is available to donate in " . $city . "!',
            ...
            Swal.fire({
              title: 'Sorry',
              text: 'No matching blood group donor is available to donate in this city!',
              icon: 'error',
              showClass: {
                popup: `
                  animate__animated
        ...
        <div class="container">
          <figure class="cta-banner">
            <img src="./assets/images/cta-banner.png" width="1056" height="1076" loading="lazy"  alt="cta banner" class="w-100">
              <!-- <img src="./assets/images/Firefly 20240602135032.png" width="1056" height="500" loading="lazy" alt="cta banner" class="w-100"> -->
  ...
  <script>
    window.addEventListener('load', () => {
      document.getElementById('animatedImage').classList.add('image-animation-loaded');
    });
  </script>
</body>
